...
<p>___________</p>`,
  ...
  resume: {
    title: "Резюме",
    content: `<h1 style="text-align:center">ИВАН ИВАНОВ</h1>
<p style="text-align:center"><b>Менеджер проектов</b><br>+7 (999) 000-00-00 · ivan@mail.ru · Москва</p>
<h2>О себе</h2>
<p>Опытный специалист с 5+ годами опыта в управлении IT-проектами. Успешно реализовал 30+ проектов в сроки и бюджет.</p>
<h2>Опыт работы</h2>
<p><b>ООО «Компания»</b> — Менеджер проектов (2022–настоящее время)</p>
<ul><li>Управление командой из 8 человек</li><li>Запуск продукта с нуля до 10K пользователей</li></ul>
<h2>Образование</h2>
<p>МГУ · Экономика · 2017</p>
<h2>Навыки</h2>
<p>Jira, Scrum, Kanban, PMBOK, MS Project</p>`,
  },
  invoice: {
    title: "Счёт на оплату",
    content: `<h1 style="text-align:center">СЧЁТ № ___ от __.__.20__</h1>
<p><b>Поставщик:</b> ООО «___________»<br>ИНН: ___________ / КПП: ___________<br>Банк: ___________ / р/с ___________</p>
<p><b>Покупатель:</b> ___________</p>
...
<tr><td>1</td><td>Услуга 1</td><td>1</td><td>10 000</td><td>10 000</td></tr>
<tr><td>2</td><td>Услуга 2</td><td>2</td><td>5 000</td><td>10 000</td></tr>
<tr><td colspan="4" style="text-align:right"><b>ИТОГО:</b></td><td><b>20 000 ₽</b></td></tr>
</table>
<p>Сумма прописью: <i>Двадцать тысяч рублей 00 копеек</i></p>
<p>Оплата в течение 5 банковских дней.</p>`,
  },
  act: {
    title: "Акт выполненных работ",
    content: `<h1 style="text-align:center">АКТ № ___ от __.__.20__</h1>
<p style="text-align:center"><i>выполненных работ (оказанных услуг)</i></p>
<p><b>Исполнитель:</b> ООО «___________»</p>
<p><b>Заказчик:</b> ___________</p>
<p>Мы, нижеподписавшиеся, составили настоящий Акт о том, что Исполнителем выполнены следующие работы:</p>
<ol><li>Работа 1 — выполнена в полном объёме</li><li>Работа 2 — выполнена в полном объёме</li></ol>
<p><b>Стоимость:</b> _______ руб.</p>
<p>Заказчик претензий по объёму, качеству и срокам не имеет.</p>
<p style="margin-top:40px">Исполнитель: __________________ /___________/</p>
<p>Заказчик: __________________ /___________/</p>`,
  },
  offer: {
    title: "Коммерческое предложение",
    content: `<h1 style="text-align:center">КОММЕРЧЕСКОЕ ПРЕДЛОЖЕНИЕ</h1>
<p>Уважаемый ___________!</p>
<p>Благодарим за интерес к нашим услугам. Предлагаем вам следующие условия сотрудничества:</p>
<h2>Что вы получите</h2>
<ul><li>✓ Преимущество 1</li><li>✓ Преимущество 2</li><li>✓ Преимущество 3</li></ul>
<h2>Стоимость</h2>
<table border="1" cellpadding="8" style="width:100%;border-collapse:collapse">
<tr><th>Пакет</th><th>Что входит</th><th>Цена</th></tr>
<tr><td>Базовый</td><td>Основные услуги</td><td>10 000 ₽</td></tr>
<tr><td>Расширенный</td><td>+ дополнительные опции</td><td>25 000 ₽</td></tr>
<tr><td>Премиум</td><td>Всё включено</td><td>50 000 ₽</td></tr>
</table>
<p>Предложение действительно до __.__.20__.</p>
<p>С уважением,<br>___________</p>`,
  },
  nda: {
    title: "Соглашение о неразглашении (NDA)",
    content: `<h1 style="text-align:center">СОГЛАШЕНИЕ О НЕРАЗГЛАШЕНИИ</h1>
<p>г. Москва &nbsp;&nbsp;&nbsp;&nbsp; «___» __________ 20__ г.</p>
<p><b>Сторона 1:</b> ___________<br><b>Сторона 2:</b> ___________</p>
<h2>1. Предмет</h2>
<p>Стороны договорились о неразглашении конфиденциальной информации, полученной в ходе сотрудничества.</p>
<h2>2. Конфиденциальная информация</h2>
<p>Под конфиденциальной информацией понимается любая информация о деятельности Сторон, их клиентах, технологиях и финансовых условиях.</p>
<h2>3. Срок действия</h2>
<p>Соглашение действует 5 лет с момента подписания.</p>
<h2>4. Ответственность</h2>
<p>За разглашение информации виновная Сторона выплачивает штраф в размере 500 000 рублей.</p>`,
  },
  complaint: {
    title: "Претензия",
    content: `<p style="text-align:right">Кому: ___________<br>От кого: ___________<br>Адрес: ___________</p>
<h1 style="text-align:center">ПРЕТЕНЗИЯ</h1>
<p>«___» __________ 20__ г. между нами был заключён договор №___ о ___________.</p>
<p>Согласно условиям договора, Вы обязались ___________, однако ___________.</p>
<p>В связи с нарушением условий договора, требую в течение 10 дней:</p>
<ol><li>___________</li><li>Возместить убытки в размере _______ руб.</li></ol>
<p>В случае неудовлетворения претензии буду вынужден обратиться в суд.</p>
<p>«___» __________ 20__ г. &nbsp;&nbsp;&nbsp;&nbsp; Подпись: ___________</p>`,
  },
  order: {
    title: "Приказ",
    content: `<h1 style="text-align:center">ПРИКАЗ № ___</h1>
<p style="text-align:center">от «___» __________ 20__ г.</p>
<p style="text-align:center"><b>О ___________</b></p>
<p>В целях ___________ ПРИКАЗЫВАЮ:</p>
<ol><li>Назначить ___________ ответственным за ___________.</li><li>Утвердить ___________.</li><li>Контроль за исполнением настоящего Приказа возложить на ___________.</li></ol>
<p style="margin-top:40px">Директор &nbsp;&nbsp;&nbsp;&nbsp; ____________ /И.И. Иванов/</p>`,
  },
  protocol: {
    title: "Протокол совещания",
    content: `<h1 style="text-align:center">ПРОТОКОЛ</h1>
<p style="text-align:center"><i>совещания от __.__.20__</i></p>
<p><b>Присутствовали:</b><br>• ___________ (председатель)<br>• ___________<br>• ___________</p>
<p><b>Повестка дня:</b></p>
<ol><li>Вопрос 1</li><li>Вопрос 2</li><li>Разное</li></ol>
<h2>По первому вопросу</h2>
<p><b>Слушали:</b> ___________</p>
<p><b>Решили:</b> ___________</p>
<p><b>Ответственный:</b> ___________ &nbsp;&nbsp; <b>Срок:</b> __.__.20__</p>
<p style="margin-top:40px">Председатель: _______________ /___________/</p>
<p>Секретарь: _______________ /___________/</p>`,
  },
};
